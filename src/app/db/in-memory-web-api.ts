    ...
    createDb(){
        ...
        let starter = [
          ...
          let paneer = [
            ...
            {id:'6',name:'Malai Kofta',src:"../assets/paneer/malai-kofta.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'8',name:'Kadai Paneer',src:"../assets/paneer/kadai-paneer.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'9',name:'Tawa Paneer Masala',src:"../assets/paneer/paneer-tava-masala.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'10',name:'Paneer Pasanda',src:"../assets/paneer/paneer-pasanda.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'11',name:'Paneer Makhanwala',src:"../assets/paneer/paneer-makhanwala.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'12',name:'Achari Paneer',src:"../assets/paneer/achari-paneer.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'13',name:'Shahi Paneer',src:"../assets/paneer/shahi-paneer.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'14',name:'Chilli Paneer Gravy',src:"../assets/paneer/chilli-paneer.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
            {id:'15',name:'Paneer Bhurji',src:"../assets/paneer/paneer-bhurji.jpg",  description:'Puff pastry, cheese filling, arugula, carrot, cucumber, radish.', category:'Chicken Course', availaiility:'Not Available', weight:'450 g', isVeg:'Yes', rating:'4.5', price:'$230'},
